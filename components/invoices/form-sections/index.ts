export { default as InvoiceTypeSection } from '@/components/invoices/form-sections/InvoiceTypeSection'
...
export { default as BankDetailsSection } from '@/components/invoices/form-sections/BankDetailsSection'
